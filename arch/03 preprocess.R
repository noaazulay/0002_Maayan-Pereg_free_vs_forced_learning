#Code aim: to convert the raw data of self-report and IQ measures to clean datafiles with sub-scales and only the reqiored columns. 
...
tab%<>%
  ...
  select(subj,prolific_id,session,block,trial,reveal,ch,obey,key,rt,rw,frcA,frcB,teacher_choice,
         rw_1back,obey_1back,reveal_1back,stay.card,stay.obey,stay.key,reoffer,prob.ch,prob.unch,
         beta_teacher,prob_teacher.ch,prob_teacher.unch,abort)%>%
