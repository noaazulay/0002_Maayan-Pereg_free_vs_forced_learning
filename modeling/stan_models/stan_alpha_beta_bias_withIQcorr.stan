data {
  ...
  real           iq[Nsubjects];                        //individuals' iq score
}
transformed data{
...
//loglike estimation
  for (subject in 1:Nsubjects){
        ...
        bias[subject]               = auxiliary_parameters[subject][2] + 
                                      auxiliary_parameters[subject][4]*iq[subject]; 
        ...
        for (trial in 1:Ntrials_per_subject[subject]){
            ...
            //Qvalues update
            PE= reward[subject,trial] - Qcard[student_ch[subject,trial]];
            Qcard[student_ch[subject,trial]] += alpha[subject] * PE;
