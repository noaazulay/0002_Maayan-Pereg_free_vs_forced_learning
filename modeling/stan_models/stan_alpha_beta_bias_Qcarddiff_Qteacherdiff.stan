...
transformed parameters {
      ...
      real bias_slope2[Nsubjects];
      
      //additional variabels
      matrix [Nsubjects,Ntrials] log_lik;
      vector [Nraffle] Qnet;
      vector<lower=0, upper=1>[Narms] Qcard;
      vector [Nraffle] Qteacher; //1 is oppose and 2 is follow instractions
      real PEcard;
      real PEteacher;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  for (subject in 1:Nsubjects){
        ...
        for (a in 1:Nraffle) Qteacher[a]    = 0;
        ...
        for (trial in 1:Ntrials_per_subject[subject]){
            ...
            bias[subject]=bias_intercept[subject]+bias_slope1[subject]*(abs(Qnet[1]-Qnet[2]))+bias_slope2[subject]*(Qteacher[2]-Qteacher[1]);
